...
### 서비스 옵션 데이터 관리
- **데이터 추가/수정**: 필드에 값을 입력하면 해당 내용이 서비스 페이지에 표시됩니다
- **데이터 삭제**: 필드를 비우고 저장하면 해당 항목이 서비스 페이지에 표시되지 않습니다
- **관리 가능한 필드**:
  - 예약 방법 (booking_method)
  - 제작비 결제 방식 (payment_info)
  - 안내 사항 (guide_info)
  - 환불 규정 텍스트 (refund_policy_text)
...
**참고**: 필드를 비우고 저장하면 해당 항목이 서비스 페이지에서 사라집니다. 이는 의도된 동작입니다. 